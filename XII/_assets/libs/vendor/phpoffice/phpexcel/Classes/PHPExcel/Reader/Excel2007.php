...
if (!defined('PHPEXCEL_ROOT')) {
    ...
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Settings.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/ReferenceHelper.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Shared/File.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Calculation.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Calculation/Function.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/CalcEngine/CyclicReferenceStack.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/CalcEngine/Logger.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Worksheet.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/DocumentProperties.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/DocumentSecurity.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Style.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Reader/Excel2007/Theme.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Shared/Date.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Cell.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Cell/DataType.php');
    require(PHPEXCEL_ROOT . '../_assets/libs/vendor/phpoffice/phpexcel/Classes/PHPExcel/Cell/DefaultValueBinder.php');
