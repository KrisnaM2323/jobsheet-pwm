    ...
    <div class="header" id="header">
      <div class="container">
        <?php
            ...
            echo "<div class='alert alert-info col-4'>".$_GET['berhasil']."
           ...
           <div class="card">
            ...
            <div class="card-body" style="background-color: #ccccff;">
              ...
              <form method="post" action="upload_excel.php" enctype="multipart/form-data">
                <div class="form-row">
                  <label class="col-form-label col-sm-4" for="validationDefault01">Pilih File</label>
                  <div class="col-sm-8">
                    <input type="file" class="form-control" for="validationDefault01" id="file" name="file" placeholder="" required><br>
                  </div>
                </div>

                <button type="submit" class="btn btn-primary tengah" name="import" value="import">Import</button>
                <a href="../../_file/sample/pelajaran(1).xlsx" class="btn btn-dark xs"> Download Format Excel </a>
