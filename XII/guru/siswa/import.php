           ...
           <div class="card">
            ...
            <div class="card-body" style="background-color: #ccccff;">
              ...
              <form method="post" action="upload_excel.php" enctype="multipart/form-data">
                <div class="form-row">
                  <label class="col-form-label col-sm-4" for="file">Pilih File</label>
                  <div class="col-sm-8">
                ...
                <a href="../../_file/sample/siswa.xlsx" class="btn btn-dark text-light xs"> Download Format Excel </i></a>
