            ...
            <div class="card-body" style="background-color: #ccccff;">
              ...
              <form method="post" action="upload_excel.php" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-sm-8">
                    <input type="file" class="form-control" for="validationDefault01" name="file" id="file" placeholder="" required><br>
                  </div>
                </div>

                <button type="submit" class="btn btn-primary tengah" name="import" value="import">Import</button>
                <a href="../../_file/sample/guru(1).xlsx" class="btn btn-dark xs"> Download Format Excel </a>
