            ...
            <div class="card">
              ...
              <div class="card-body" style="background-color: #ccccff;">
                ...
                <form method="get" action="edit.php" enctype="multipart/form-data">
                  <div class="form-row">
                    <label class="col-sm-3 col-form-label" for="validationDefault01">Nama Pelajaran</label>
                    <div class="col-sm-8">
                      <input type="hidden" class="form-control" name="id_pelajaran" value="<?= $d['id_pelajaran']; ?>">
                      <input type="text" class="form-control" for="validationDefault01" name="nama_pelajaran" value="<?php echo $d['nama_pelajaran']; ?>"><br>
                    </div>
                  </div>
                  <div class="form-row">
                    <label class="col-sm-3 col-form-label" for="validationDefault01">Keterangan</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" for="validationDefault01" name="keterangan" value="<?php echo $d['keterangan']; ?>"><br>
                    </div>
                  </div>
