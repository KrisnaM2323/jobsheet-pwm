          ...
          <div class="card">
            ...
            <div class="card-body" style="background-color: #ccccff;">
              ...
              <form method="post" action="proses.php" enctype="multipart/form-data">
                <div class="form-row">
                  <label class="col-form-label col-sm-4" for="validationDefault01">Nama Pelajaran</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" for="validationDefault01" name="nama_pelajaran" placeholder="" required><br>
                  </div>
                </div>
                <div class="form-row">
                  <label class="col-form-label col-sm-4" for="validationDefault02">Keterangan</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" for="validationDefault02" name="keterangan" placeholder="" required><br>
                  </div>
                </div>
                ...
                <!-- <div class="form-row">
                  ...
                  <div class="col-sm-8">
                    <select name="id_jurusan" id="validationDefault04" class="form-control">
                      ...
                      <?php
                      include '../siswa/connect.php';
                      $data = mysqli_query($connect, "SELECT * from table_jurusan ORDER BY id_jurusan ASC");
