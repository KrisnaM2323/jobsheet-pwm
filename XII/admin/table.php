...
<body class="bg-success">
  ...
  <div class="container">
      <nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-primary flex-md-nowrap p-0 shadow py-1">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
                  <a class="nav-link text-light" href="#">Tabel Siswa</a>
                </li>
              </ul>
              <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
        ...
        <ul class="navbar-nav px-3">
          <li class="nav-item text-nowrap">
            <a class="nav-link" href="../logout.php"><i class="fas fa-power-off"> Log out </i></a>
          </li>
        </ul>
      </nav>
    </div>
  ...
  <section>
    <div class="header" id="header">
      <div class="container">
        <h1 class="row justify-content-center text-warning pt-5">Tabel Siswa</h1><br>
        ...
        if(isset($_GET['pesan'])){
          ...
          }else if($_GET['pesan']=="gagal_diubah"){
            echo "<div class='alert alert-danger tengah col-lg-4' role='alert'>
                    <span class='tengah'><b>Data Gagal Diubah</b></span>
                    </div>";  



          // }else if($_GET['pesan']=="gambar_diubah"){
          //   echo "<div class='alert alert-success tengah col-lg-4' role='alert'>
          //           <span class='tengah'><b>Data berhasil diubah</b></span>
          //           </div>";  

          }else if($_GET['pesan']=="gambar_gagal"){
            echo "<div class='alert alert-warning tengah col-lg-4' role='alert'>
                    <span class='tengah'><b>Gambar gagal Diubah</b></span>
                    </div>";  
      ...
      <div class="col"> 
        ...
        <a href="siswa/form.php" class="text-primary btn btn-primary">
          <span class="row justify-content-center text-white" align="center"><i class="fas fa-plus"> Tambah Data &nbsp;</i></span>
        </a>
        <a href="siswa/cetak.php" target="_blank" class="text-danger btn btn-light">
          <span class="row justify-content-center" align="center"><i class="fas fa-file-pdf"> Cetak &nbsp;</i></span>
        </a>
        <a href="siswa/import.php" class="text-info btn btn-light">
          <span class="row justify-content-center text-warning" align="center"><i class="fas fa-file-import"> Import &nbsp;</i></span>
        </a>
        <a href="siswa/function_export.php" class="text-info btn btn-light">
      ...
      <div class="col col-auto">
        <form class="pb-5" action="" method="post">
          <table border="5" cellpadding="1" align="left" class="bg-dark table-responsive table-hover">
            <tr class="text-dark bg-info justify-content-center" align=center>
              <th>NO</th>
              <th>NISN</th>
              <th>Nama</th>
              <!-- <th>Email</th> -->
            ...
            while ($d = mysqli_fetch_array($data)) {
              ...
              <tr class="text-light">
                ...
                <td>
                  <?=
                      "<img src='../images/gambar_siswa/" . $d['foto'] . "' width='50' height='50'>";
                    ?>
                </td>

                <td align="center">
                  <a class="text-white badge badge-primary" href="siswa/update.php?id_siswa=<?= $d['id_siswa']; ?>"><i class="fas fa-pencil-alt"></i></a>
                  <a class="text-white badge badge-danger" href="siswa/delete.php?id_siswa=<?= $d['id_siswa']; ?>"><i class="fas fa-trash-alt"></i></a>
                  <a class="text-white badge badge-warning" href="siswa/pdf.php?id_siswa=<?= $d['id_siswa']; ?>" target="_blank"><i class="fas fa-print"></i></a>
                </td>
              </tr>
