        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
                  <a class="nav-link text-light" href="#">Tabel Pelajaran</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <section>
    <div class="header" id="header">
      ...
      <span class="pt-5">
        ...
        <h1 class="row justify-content-center text-warning pt-5">
          Tabel Pelajaran
        </h1><br>
        <?php
        if(isset($_GET['pesan'])){
              ...
              <table border="5" cellpadding="2" class="bg-dark text-align-center table-responsive table-hover">
                ...
                while ($d = mysqli_fetch_array($data)) {
                  ...
                  <tr class="text-light">
                    ...
                    <td><?= $d["keterangan"]; ?></td>
                    <td align="center">
                      <a class="text-white badge badge-primary" href="pelajaran/update.php?id_pelajaran=<?= $d['id_pelajaran']; ?>"><i class="fas fa-pencil-alt"></i></a>
                      <a class="text-white badge badge-danger" href="pelajaran/delete.php?id_pelajaran=<?= $d['id_pelajaran']; ?>"><i class="fas fa-trash-alt"></i></a>
                      <a class="text-white badge badge-warning" href="pelajaran/pdf.php?id_pelajaran=<?= $d['id_pelajaran']; ?>" target="_blank"><i class="fas fa-print"></i></a>
                    </td>
                  </tr>
