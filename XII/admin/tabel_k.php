    ...
    <div class="header" id="header">
      <div class="container">
        ...
        <a href="kelas/form.php" class="btn btn-primary">
          <span class="row justify-content-center text-white" align="center"><i class="fas fa-plus"> Tambah Data &nbsp;</i></h5>
        </a>
              ...
              <table border="5" cellpadding="2" class="bg-dark text-align-center table-responsive table-hover">
                ...
                while ($d = mysqli_fetch_array($data)) {
                  ...
                  <tr class="text-light">
                    ...
                    <td><?= $d["nm_jurusan"]; ?></td>
                    <td align="center">
                      <a class="text-white badge badge-primary" href="kelas/update.php?id_kelas=<?= $d['id_kelas']; ?>"><i class="fas fa-pencil-alt"></i></a>
                      <a class="text-white badge badge-danger" href="kelas/delete.php?id_kelas=<?= $d['id_kelas']; ?>"><i class="fas fa-trash-alt"></i></a>
                      <a class="text-white badge badge-warning" href="kelas/pdf.php?id_kelas=<?= $d['id_kelas']; ?>" target="_blank"><i class="fas fa-print"></i></a>
                    </td>
                  </tr>
