          ...
          <div class="card">
            ...
            <div class="card-body" style="background-color: #ccccff;">
              ...
              <form method="post" action="proses.php" enctype="multipart/form-data">
                <div class="form-row">
                  <label class="col-sm-4 col-form-label" for="validationDefault01">NIK</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" for="validationDefault01" name="nik" placeholder="" required><br>
                  </div>
                </div>
                ...
                <div class="form-row">
                  ...
                  <div class="col-sm-8">
                    <select name="id_pelajaran" id="validationDefault03" class="form-control">
                      <option value="">Pilih Mata Pelajaran</option>
                      <?php
                      include '../siswa/connect.php';

                      $data = mysqli_query($connect, "SELECT * from tb_pelajaran ORDER BY id_pelajaran ASC");
                ...
                <div class="form-row">
                  <label for="validationDefault05" class="col-sm-4 col-form-label">Foto</label>
                  <div class="col-sm-8">
                    <input type="file" class="form-control" id="validationDefault05" name="img" placeholder=" " required><br>
                  </div>
                </div>
                ...
                <div class="form-row">
                  ...
                  <div class="col-sm-8">
                    <select name="gender" id="validationDefault07" class="form-control">
                ...
                <div class="form-row">
                  <label for="validationDefault08" class="col-sm-4 col-form-label">No HP</label>
                  <div class="col-sm-8">
                    <input type="number" class="form-control" id="validationDefault08" name="no_hp" placeholder="+62"><br>
                  </div>
                </div>
