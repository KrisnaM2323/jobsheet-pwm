...
<body class="bg-success">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
                  <a class="nav-link text-light" href="#">Tabel Guru</a>
                </li>
              </ul>
              <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
  ...
  <section>
    <div class="header" id="header">
      <div class="container">
        <h1 class="row justify-content-center text-warning pt-5">Tabel Guru</h1><br>
        <?php
        if(isset($_GET['pesan'])){
      ...
      <div class="row my-4">
        <div class="col-md-3">
          ...
          <form class="pb-5" action="" method="post">
            <table border="5" cellpadding="2" align="left" class="bg-dark table-responsive table-hover">
            ...
            while ($d = mysqli_fetch_array($data)) {
              ...
              <tr class="text-light">
                ...
                <td>
                  <?=
                      "<img src='../images/gambar_guru/" . $d['foto'] . "' width='50' height='50'>";
                    ?>
                </td>
                <td align="center">
                  <a class="text-white badge badge-primary" href="guru/update.php?id_guru=<?= $d['id_guru']; ?>"><i class="fas fa-pencil-alt"></i></a>
                  <a class="text-white badge badge-danger" href="guru/delete.php?id_guru=<?= $d['id_guru']; ?>"><i class="fas fa-trash-alt"></i></a>
                  <a class="text-white badge badge-warning" href="guru/pdf.php?id_guru=<?= $d['id_guru']; ?>" target="_blank"><i class="fas fa-print"></i></a>
                </td>
              </tr>
