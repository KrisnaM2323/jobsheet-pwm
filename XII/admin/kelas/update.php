      ...
      <div class="container">
        <div class="col-4 marginator kanan">
          ...
          <?php
            ...
            $data = mysqli_query($connect, "SELECT * from tbl_kelas where id_kelas='$id_kelas' ")or(mysqli_error($connect));
            ...
            <div class="card">
              ...
              <div class="card-body" style="background-color: #ccccff;">
                ...
                <form method="get" action="edit.php">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-sm-8">
                      <select name="id_jurusan" id="validationDefault03" class="form-control">
                        ...
                        <?php
                          include '../siswa/connect.php';
                          $data = mysqli_query($connect, "SELECT * from tb_jurusan");
                  ...
                  <button type="submit" class="btn btn-primary tengah" name="simpan" value="simpan">Ubah Data</button>
