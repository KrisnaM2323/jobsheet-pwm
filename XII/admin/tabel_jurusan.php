...
<body class="bg-success">
            ...
            <div class="navbar-nav">
              <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
                  <a class="nav-link text-light" href="#">Tabel Jurusan</a>
                </li>
              </ul>
              <ul class="navbar-nav px-3">
                <li class="nav-item text-nowrap">
  ...
  <section>
    <div class="header" id="header">
      <div class="container">
        <h1 class="row justify-content-center text-warning pt-5">Tabel Jurusan</h1><br>
        <?php
        if(isset($_GET['pesan'])){
        ...
        <div class="col pb-4">
          ...
          <a href="jurusan/form.php" class="btn btn-primary">
            <span class="text-white row justify-content-center" align="center"><i class="fas fa-plus"> Tambah Data &nbsp;</i></span>
          </a>
          <a href="jurusan/cetak.php" target="_blank" class="text-danger btn btn-light">
            <span class="row justify-content-center" align="center"><i class="fas fa-file-pdf"> Cetak &nbsp;</i></span>
          </a>
          <a href="jurusan/import.php" class="text-info btn btn-light">
            <span class="row justify-content-center text-warning" align="center"><i class="fas fa-file-import"> Import &nbsp;</i></span>
          </a>
          <a href="jurusan/function_export.php" class="text-info btn btn-light">
          ...
          <div class="col col-sm-auto">
            <form class="pb-5" action="" method="POST">
              <table border="5" cellpadding="2" class="bg-dark text-align-center table-responsive table-hover">
                ...
                $no = 1;
                $data = mysqli_query($connect, "SELECT * from tb_jurusan")or die(mysqli_error($connect));
                while ($d = mysqli_fetch_array($data)) {
                  ...
                  <tr class="text-light">
                    ...
                    <td><?= $d["deskripsi"]; ?></td>
                    <td align="center">
                      <a class="text-white badge badge-primary" href="jurusan/update.php?id_jurusan=<?= $d['id_jurusan']; ?>"><i class="fas fa-pencil-alt"></i></a>
                      <a class="text-white badge badge-danger" href="jurusan/delete.php?id_jurusan=<?= $d['id_jurusan']; ?>"><i class="fas fa-trash-alt"></i></a>
                      <a class="text-white badge badge-warning" href="jurusan/pdf.php?id_jurusan=<?= $d['id_jurusan']; ?>" target="_blank"><i class="fas fa-print"></i></a>
                    </td>
                  </tr>
  ...
  <!-- Script -->
  <script src="../_assets/fonts/fontawesome-5.12.1/js/all.min.css"></script>
