        ...
        <div class="col-lg-7">
          ...
          <?php
            if(isset($_GET['pesan'])){
              ...
              if($_GET['pesan']=="gagal"){
                echo "<div class='alert alert-warning col-lg-6 tengah' role='alert'><b>NIK tidak terdaftar !</b></div>";
                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form method="post" action="cek_login.php" enctype="multipart/form-data">
                                  <div class="form-row">
                                    <label class="col-form-label col-sm-4 text-gray-900" for="validationDefault01">NIK</label>
                                    <div class="col-sm-8">
                                  ...
                                  <div class="form-row">
                                    ...
                                    <button type="submit" name="login_guru" value="login_guru" class="btn btn-success">LOGIN</button>
                                  </div>

                                  <p>Login sebagai <a href="index.php">Admin</a> atau <a href="login_siswa.php">Siswa</a></p><br>
